...
echo ""
echo "Next steps:"
echo "  1. Open vstbridgectl from your application menu, or run:"
echo "     $DATA_DIR/vstbridgectl-gtk"
echo ""
echo "  2. Go to the Directories tab and click Add to add the folders"
echo "     that contain your Windows VST2, VST3, or CLAP plugins."
echo "     Typical locations inside a Wine prefix:"
echo "       ~/.wine/drive_c/Program Files/Common Files/VstPlugins         (VST2)"
echo "       ~/.wine/drive_c/Program Files/Common Files/VST3  (VST3)"
echo "       ~/.wine/drive_c/Program Files/Common Files/CLAP  (CLAP)"
echo ""
echo "  3. Go to the Sync tab and click Sync to create the bridge files."
echo ""
echo "  4. Point your DAW at the vstbridge output directories:"
